from PyQt5.QtWidgets import (QWidget,QGridLayout,QRadioButton,QMainWindow, QApplication,QCheckBox,
    QGraphicsScene,QGraphicsView,QGraphicsItem,QGraphicsRectItem,QGraphicsLineItem,QGraphicsEllipseItem,
)
...
class GraphicsScene(QGraphicsScene):
    ...
    def mousePressEvent(self, event):
        if not self._mode: 
            ...
            return
        if self._name == 'Rect': self._item = QGraphicsRectItem()
        elif self._name == 'Ellipse': self._item = QGraphicsEllipseItem()
        elif self._name == 'Line': self._item = QGraphicsLineItem()
        else: return
    ...
    def mouseReleaseEvent(self, event):
        ...
        if self._item:
            ...
            try: self._item.setBrush(get_color())
            except: pass
